/**
 * Internal-link checker for the built site. Runs after `astro build` (see the
 * `check` npm script). Fails on:
 *   - a root-absolute internal link missing the `/swift-sdk` base (the bug that
 *     the middleware is meant to prevent), or
